...
<div style="display:flex;flex-direction:column;height:100%">
  ...
  <div ref="logContainer" style="flex:1;min-height:0;overflow-y:auto;background:#1e1e1e;border-radius:6px;padding:10px 14px;font-family:'Courier New',monospace;font-size:13px;line-height:1.7">
